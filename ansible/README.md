...
This directory contains Ansible playbooks and roles to install and configure a co-located HashiCorp Nomad v2.0.3 + Consul v2.0.1 cluster on the infrastructure provisioned by Terraform.
